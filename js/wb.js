(function() {
    ...
    WB2.Module = {
        ...
        publish: {
            versions: {
                ...
                latest: {
                    js: "publish.js?version=20130731",
        ...
        like: {
            versions: {
                "1.0": {
                    js: "like{ver}.js?version=20131028"
                },
                latest: {
                    js: "like.js?version=20131028",
                    css: "/t4/appstyle/widget/css/praiseButton/praiseButton.css?version=20130527"
                }
            }
        },
        iframeWidget: {
            versions: {
                latest: {
                    js: "iframeWidget.js?version=20131023"
                }
            }
        },
        invite: {
    ...
    WB2._config.cdn_version = "20130730";
    WB2.oauthData = {};
    WB2.init = init;
    WB2.login = login;
    WB2.logout = logout;
